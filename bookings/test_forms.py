...
class TestUserProfileForm(TestCase):
    ...
    def test_form_is_valid_when_consent_to_mailing_list_not_given(self):
        ...
        self.assertTrue(
            form.is_valid(), msg='Form is invalid when mailing'
            ' list consent not given')
...
class TestReservationForm(TestCase):
    ...
    def test_form_is_valid_when_all_fields_selected(self):
        ...
        WorkshopActivity.objects.create(session_name="adult workshop1",
                                        excerpt="a workshop",
        ...
        Workshop.objects.create(category=typ_pk, activity=act_pk,
                                slug="workshop-slug",
    ...
    def test_form_not_valid_with_no_tickets(self):
        ...
        self.assertFalse(
            form.is_valid(), msg='Form is valid even if no tickets selected')

    def test_form_is_valid_has_dietary_requirements_false(self):
        """ Test that form is valid when no dietary requirements declared. """
        WorkshopActivity.objects.create(session_name="family workshop",
                                        excerpt="a workshop",
                                        full_description="long description")
        ...
        self.assertTrue(
            form.is_valid(), msg='Form is invalid if no dietary'
    ...
    def test_form_is_valid_consent_given_is_false(self):
        ...
        self.assertTrue(form.is_valid(),
                        msg='Form is invalid if consent given is false')
    ...
    def test_form_is_valid_additional_info_blank(self):
        ...
        self.assertTrue(form.is_valid(),
                        msg='Form is invalid if additional info is left blank')
    ...
    def test_form_is_invalid_no_workshop_selected(self):
        ...
        self.assertFalse(
            form.is_valid(), msg='Form is valid if no workshop selected')
...
class TestFeedbackForm(TestCase):
    ...
    def test_form_is_invalid_when_feedback_rating_is_blank(self):
        ...
        self.assertFalse(
            form.is_valid(), msg='Form is valid when feedback '
            'rating is blank')
